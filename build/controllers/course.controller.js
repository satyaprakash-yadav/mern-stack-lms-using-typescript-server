...
exports.generateVideoUrl = exports.deleteCourse = exports.getAllUsersCourses = exports.addReplyToReview = exports.addReview = exports.addAnswer = exports.addQuestion = exports.getCourseByUser = exports.getAllCourses = exports.getSingleCourse = exports.editCourse = exports.uploadCourse = void 0;
...
exports.getSingleCourse = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (isCacheExist) {
            ...
            await redis_1.redis.set(courseId, JSON.stringify(course), "EX", 404800); // 7 days
            res.status(200).json({
                success: true,
                course,
            });
...
exports.getAllUsersCourses = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
